    ...
    report.add(
        TextSection(
            ...
            html=(
                ...
                "For example, a legislator who appears highly conservative on Dim 1 but "
                "scores extreme negative on Dim 2 frequently votes against bills nearly "
                "all co-partisans support.</p>"
                "<p><strong>Wide Dim 2 HDIs</strong> are expected. For most "
                "legislators, the second dimension has weak signal. "
